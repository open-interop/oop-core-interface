...
# All repos
OOP_AMQP_ADDRESS=amqp://guest:guest@172.17.0.1
RABBITMQ_URL=amqp://guest:guest@172.17.0.1
...
OOP_CORE_API_URL=http://172.17.0.1:9001/services/v1
...
# Core
OOP_AMQP_ADDRESS=amqp://172.17.0.1
