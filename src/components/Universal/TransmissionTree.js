                        ...
                        >
                                ...
                                <ListItem>
                                    <div className="card-label">
                                        <ListItemLabel description="UUID">
                                            {node.messageUuid || "No data available"}
                                        </ListItemLabel>
                                    </div>
                                </ListItem>
                            </FlexGridItem>
                                ...
                                <ListItem>
                                    <div className="card-label">
                                        <ListItemLabel description="Transmitted At">
                                            {node.transmittedAt || "No data available"}
                                        </ListItemLabel>
                                    </div>
                                </ListItem>
                            </FlexGridItem>
                            <FlexGridItem {...itemProps}>
                                <Button
                                    ...
                                    $as={Link}
                                    to={{
                                        pathname: `/transmissions/${node.transmissionId}`,
                                        state: {
                                            from: `/messages/${node.messageId}`,
                                        },
                                    }}
                                >
